...
return (
  <div className="Home">
    ...
    <h3>Welcome To Game Renting Store</h3>
    </div>
    <div className="HomeImges">
      <ul>
        <Popup trigger={imagePopup1} setTrigger={setImagePopup1}>
        </Popup>
          <img src= {'https://assets1.ignimgs.com/2018/03/06/fortnite---button-1520296499714.jpg?width=300'} alt="pic" onClick={()=> setImagePopup1(true)}/>
        <Popup2 trigger={imagePopup2} setTrigger={setImagePopup2}>
        </Popup2> 
          <img src= {'https://assets-prd.ignimgs.com/2021/08/17/call-of-duty-vanguard-button-00-1629164778736.jpg?width=300'} alt="pic" onClick={()=> setImagePopup2(true)}/>
        <Popup3 trigger={imagePopup3} setTrigger={setImagePopup3}>
        </Popup3> 
          <img src= {'https://assets-prd.ignimgs.com/2020/11/14/marvels-spider-man-general-1605330330912.jpg?width=300'} alt="pic" onClick={()=> setImagePopup3(true)}/>
        <Popup4 trigger={imagePopup4} setTrigger={setImagePopup4}>
        </Popup4>
          <img src= {'https://assets1.ignimgs.com/2018/06/13/super-smash-btros-ultimate---button-0001-1528851298611.jpg?width=300'} alt="pic" onClick={()=> setImagePopup4(true)}/>
        <Popup5 trigger={imagePopup5} setTrigger={setImagePopup5}>
        </Popup5>
          <img src= {'https://assets-prd.ignimgs.com/2021/10/01/fifa-22-legacy-edition-button-1633122224466.jpg?width=300'} alt="pic" onClick={()=> setImagePopup5(true)}/>
        <Popup6 trigger={imagePopup6} setTrigger={setImagePopup6}>
        </Popup6>
          <img src= {'https://assets-prd.ignimgs.com/2021/10/21/lego-star-wars-castaway-button-1634780317249.jpg?width=300'} alt="pic" onClick={()=> setImagePopup6(true)}/>
        <Popup7 trigger={imagePopup7} setTrigger={setImagePopup7}>
        </Popup7>
          <img src= {'https://assets-prd.ignimgs.com/2021/06/02/srx-button-1622596548857.jpg?width=300'} alt="pic" onClick={()=> setImagePopup7(true)}/>
        <Popup8 trigger={imagePopup8} setTrigger={setImagePopup8}>
        </Popup8>
          <img src= {'https://assets-prd.ignimgs.com/2020/09/28/dynasty-warriors-9-empires-button-001-1601330278777.jpg?width=300'} alt="pic" onClick={()=> setImagePopup8(true)}/>
        <Popup9 trigger={imagePopup9} setTrigger={setImagePopup9}>
        </Popup9>
          <img src= {'https://assets-prd.ignimgs.com/2021/06/25/crash-drive-3-button-1624640707993.jpg?width=300'} alt="pic" onClick={()=> setImagePopup9(true)}/>
        <Popup10 trigger={imagePopup10} setTrigger={setImagePopup10}>
        </Popup10>
          <img src= {'https://assets1.ignimgs.com/2019/06/04/legend-of-zelda-breath-of-the-wild---button-1559683061451.jpg?width=300'} alt="pic" onClick={()=> setImagePopup10(true)}/>
      </ul>
    </div>
  </div>
);
